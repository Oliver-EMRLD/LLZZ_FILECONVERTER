...
static char         *version = "1.6 -- 2021.05.23";
...
char                *BoolMultithread = getenv("BOOL_MTHRD");
...
/*
    ...
    if(BoolMultithread != 'Y')
        ...
        printf("Singlethread");
        threadarg[0].from = 0;
        threadarg[0].till = count_record;
        convertllzz((void *)&threadarg[0]);
        }
