...
static char         *version = "1.4 -- 2021.05.22";
...
printf("Intellectual property of Balint Oliver\n");
printf("In case of any issues/requests please contact me:\n");
printf("Email       oliver.balint03@gmail.com\n");
printf("GitHub      https://github.com/princefromplanetmoon/LLZZ_FILECONVERTER\n");
...
if(strncmp(argv[1], "CVT2NTHE", 5) == 0)
  ...
  //      printf("%i\n", currentthread);
    ...
    if(strncmp(argv[2], "FIXED", 5) == 0)
        ...
        strncpy(&string_suffix, suffix, strlen(suffix)-strlen(lenstr));
        strncat(&string_suffix, lenstr, strlen(lenstr));
        strncat(&string_suffix, ">", 2);
        printf("SUffix : %s\n", string_suffix);
        buffer_tmp = malloc(largest_record_size+SUFFIX_LENGTH+1);
